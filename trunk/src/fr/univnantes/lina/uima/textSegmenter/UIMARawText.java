...
public class UIMARawText extends RawText {
	 ...
	 *  @param tokenTypeStr		string name of the Token Annotation type
	 *  @param tokenFeature		string name of the feature of the Token Annotation 
	 *  
	 */
	public UIMARawText(JCas aJCas, String sentenceTypeStr, String tokenTypeStr, String tokenFeature) {
		...
		if (debug) System.out.println("Debug: indexSentences.size() "+indexSentences.size());
